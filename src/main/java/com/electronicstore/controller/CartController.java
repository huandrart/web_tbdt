...
public class CartController {
    ...
    @GetMapping("/checkout")
    public String checkoutRedirect(Authentication authentication) {
        // Redirect to main checkout flow
        return "redirect:/checkout";
    }
    
    // Removed duplicate order placement logic - now handled by CheckoutController
}
